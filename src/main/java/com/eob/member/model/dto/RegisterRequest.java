...
public class RegisterRequest {
    ...
    @Pattern(regexp = "^[0-9]{6}$", message = "주민등록번호 앞자리는 6자리 숫자만 가능합니다.")
    private String jumin1;

    @NotBlank(message = "주민등록번호 뒤 1자리를 입력해주세요.")
    @Pattern(regexp = "^[1-4]{1}$", message = "주민등록번호 뒤 자리는 1~4 중 하나여야 합니다.")
    ...
    // // 경도
    // // @NotEmpty(message = "longitude를 불러올 수 없습니다.")
    // private float longitude;

    // // 위도
    // // @NotEmpty(message = "latitude를 불러올 수 없습니다.")
