...
public class MainService {
    ...
    public Page<ShopEntity> getShopList(String category, Pageable pageable) {
        ...
        // // 위치, 카테고리에 맞는 상점 조회
        // Page<ShopEntity> shopList =
        // shopRepository.findByProductCatNameAndLocation(category, minLat, maxLat,
        // minLng,
        // maxLng, pageable);
        Page<ShopEntity> shopList = shopRepository.findByProductCatName(category, pageable);
        return shopList;
        // } catch (Exception e) {
        // return e.getMessage();
        // }
